...
router.get('/api/admin/product/:id', function (req, res) {
...
router.delete('/api/admin/product/:id', function (req, res) {
...
router.post('/api/admin/product', function (req, res) {
...
router.post('/api/admin/product/promo', function (req, res) {
...
router.put('/api/admin/product/:id', function (req, res) {
